class AccountTransactionServiceObject
  ...
  def self.withdraw_from_account(account,user,amount)
    ...
    credit_transaction = Transaction.new(:source => user,:target => account,:amount => amount,:transaction_type => Transaction.transaction_types[:credit])
  ...
  def self.deposit_to_account(account,user,amount)
    debit_transaction = Transaction.new(:source => user,:target => account,:amount => amount,:transaction_type => Transaction.transaction_types[:debit])
